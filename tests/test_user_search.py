...
class UsersSearchTestCase(unittest.TestCase):
    ...
    def test_no_valid_id(self, mock):
    ...
    @patch.object(DataBase, 'get_users_id')
    def test_not_only_valid_id(self, mock):
        with self.assertLogs('SEARCH USERS', level='WARNING') as cm:
    ...
    @patch.object(DataBase, 'get_users_id')
    def test_more_than_100_users(self, mock):
        with self.assertLogs('SEARCH USERS', level='WARNING') as cm:
            r = []
    ...
    @patch.object(DataBase, 'get_users_id')
    def test_more_than_100_users2(self, mock):
